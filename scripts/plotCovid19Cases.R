...
system("convert -delay 40 *.png US_covid-19_timelapse.gif")
...
system("convert -delay 40 *.png US_covid-19_timelapse_counties.gif")

file.move("/Users/dmacguigan/Documents/covid19/plots/dayPlots/US_covid-19_timelapse_counties.gif", "/Users/dmacguigan/Documents/covid19/plots/")
